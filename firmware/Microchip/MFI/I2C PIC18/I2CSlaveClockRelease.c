...
/*******************************************************************************
  ...
  Precondition:
    The module must have been configured appropriately to enable clock
    stretching, the module must have been enabled, and a transfer
...
void I2CSlaveClockRelease ( I2C_MODULE id )
{
    ...
    i2cRegisters->SSPxCON1.bits.CKP = 1;
}
