...
//    return ( i2cRegisters->SSPxSTATbits.S == 0 && i2cRegisters->SSPxSTATbits.P == 1 );
// The stupid S and P bits don't work!!!
    return !(i2cRegisters->SSPxCON2.bits.SEN   || i2cRegisters->SSPxCON2.bits.RSEN ||
             i2cRegisters->SSPxCON2.bits.PEN   || i2cRegisters->SSPxCON2.bits.RCEN ||
             i2cRegisters->SSPxCON2.bits.ACKEN || i2cRegisters->SSPxSTAT.bits.R_W);
}
