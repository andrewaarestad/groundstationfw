...
FileName:       i2c.h
Processor:      dsPIC33E
Compiler:       Microchip MPLAB C30 v3.30 or higher
...
#define _I2C_H_
        ...
        // PIC24E processor
        #include <p24Exxxx.h>
    #elif defined(__dsPIC33E__) // Microchip C30 compiler
        // dsPIC33E processor
        #include <p33Exxxx.h>
    #else
        #include <p30sim.h>
...
#define I2CCalculateBRGConstant(sourceClock, i2cClock)  (((sourceClock/i2cClock) - (sourceClock/10000000ul) - 2) & 0x01FF)
#define I2CGeneratedFrequency(i, sourceClock,i2cClock)  (sourceClock / (I2CCalculateBRGConstant(sourceClock,i2cClock) + (sourceClock/10000000ul) + 2))
