/******************************************************************************
    CandleDragon DotStack Bluetooth Stack Drivers for the
    Apple MFI Development Library
...
#ifndef MFI_BT_DOTSTACK_H
#define MFI_BT_DOTSTACK_H
