...
File Name:       MFI_Authentication.h
Dependencies:    None
...
#ifndef MFI_AUTHENTICATION_H
#define MFI_AUTHENTICATION_H
...
BOOL MFIAU_Initialize ( void );
BOOL MFIAU_IsAuthenticating ( void );
void MFIAU_ProcessiPodDetach ( void );
BOOL MFIAU_ProcessPacket( void );
BOOL MFIAU_ProcessCompletion( void );
void MFIAU_Tasks ( void );
