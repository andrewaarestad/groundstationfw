...
#if defined( __C30__ )
    #if defined(__PIC24F__) || defined(__PIC24FK__)     // Microchip C30 compiler
        // PIC24F processor
        #include <p24Fxxxx.h>
...
//    #include "i2c original.h"  // Legacy definitions, do not use
//#endif
...
// These devices have an I2C1 module.
#if defined(i2c_v1_1) || defined(i2c_v1_2) || defined(i2c_v1_3) || defined (i2c_v1_4) || defined (LIB_BUILD)
    #define _I2C1
    #define _I2C1_BASE_ADDRESS                       0x0200
#else
    #error This device has no I2C support.
#endif

// These devices have an I2C2 module.
#if defined(i2c_v1_2) || defined(i2c_v1_3) || defined (i2c_v1_4) ||defined(LIB_BUILD)
    #define _I2C2
    #define _I2C2_BASE_ADDRESS                       0x0210
#endif

// These devices have an I2C3 module.
#if defined(i2c_v1_3) || defined(LIB_BUILD)
    #define _I2C3
    #define _I2C3_BASE_ADDRESS                       0x0270
#endif
...
//DOM-IGNORE-BEGIN
    // The BRG register has only 9 active bits.
#define I2CCalculateBRGConstant(sourceClock, i2cClock)  (((sourceClock/i2cClock) - (sourceClock/10000000ul) - 1) & 0x01FF)
#define I2CGeneratedFrequency(i, sourceClock,i2cClock)  (sourceClock / (I2CCalculateBRGConstant(sourceClock,i2cClock) + (sourceClock/10000000ul) + 1))
