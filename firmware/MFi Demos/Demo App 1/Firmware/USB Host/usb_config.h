...
// <MFIConfig.USB_Host_TPL_Count>
#define NUM_TPL_ENTRIES                    1  // iAP requires 1
// </MFIConfig.USB_Host_TPL_Count>
...
#define USB_HOST_APP_EVENT_HANDLER MFI_USB_ApplicationEventHandler
...
// <MFIConfig.USB_Host_Configuration>
// Additional USB Host configuration requirements
// </MFIConfig.USB_Host_Configuration>

// <MFIConfig.USB_Host_Macros>
#define USBTasks()                  \
    {                               \
        USBHostTasks();             \
        USBHostHIDTasks();          \
